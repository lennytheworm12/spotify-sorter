...
def prepare(root):
    ...
    if (run / 'input_hashes.json').exists():
        ...
        return
    config = read(root / 'configs/style_prior_v2.json')
    ...
    paths = sources + [root / 'configs/style_prior_v2.json', root / E3 / 'historical_reference_matrices.npz', root / E3 / 'post_review_rating_snapshot.json', root / 'models/discogs-effnet-bs64-1.pb', root / 'models/discogs-effnet-bs64-1.json']
